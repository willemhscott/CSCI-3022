...
var G=(f=Object(b["j"])(R,B),f(v=(w=y=function(e){Object(i["a"])(r,e)
var n=Object(c["a"])(r)
function r(){Object(a["a"])(this,r)
return n.apply(this,arguments)}Object(o["a"])(r,[{key:"render",value:function(){var e
var n=this.props,a=n.wrap,o=n.weight,i=n.fontStyle,c=n.size,s=n.lineHeight,_=n.letterSpacing,l=n.transform,g=n.color,b=n.children
var k=Object(p["a"])(r,this.props)
return d.a.createElement(k,Object.assign({},Object(m["b"])(this.props),{className:u()((e={},Object(t["a"])(e,B.root,true),Object(t["a"])(e,B[c],c),Object(t["a"])(e,B["wrap-".concat(a)],a),Object(t["a"])(e,B["weight-".concat(o)],o),Object(t["a"])(e,B["style-".concat(i)],i),Object(t["a"])(e,B["transform-".concat(l)],l),Object(t["a"])(e,B["lineHeight-".concat(s)],s),Object(t["a"])(e,B["letterSpacing-".concat(_)],_),Object(t["a"])(e,B["color-".concat(g)],g),e)),ref:this.props.elementRef}),b)}}])
r.displayName="Text"
return r}(s["Component"]),y.propTypes={as:l.a.elementType,children:l.a.node,color:k["a"].deprecatePropValues(l.a.oneOf(["primary","secondary","brand","success","warning","error","danger","alert","primary-inverse","secondary-inverse"]),["error"],"It will be removed in version 8.0.0. Use `danger` instead."),elementRef:l.a.func,fontStyle:l.a.oneOf(["italic","normal"]),letterSpacing:l.a.oneOf(["normal","condensed","expanded"]),lineHeight:l.a.oneOf(["default","fit","condensed","double"]),size:l.a.oneOf(["x-small","small","medium","large","x-large","xx-large"]),transform:l.a.oneOf(["none","capitalize","uppercase","lowercase"]),weight:l.a.oneOf(["normal","light","bold"]),wrap:l.a.oneOf(["normal","break-word"])},y.defaultProps={as:"span",wrap:"normal",size:"medium",letterSpacing:"normal",children:null,elementRef:void 0,color:void 0,transform:void 0,lineHeight:void 0,fontStyle:void 0,weight:void 0},w))||v)},dqQ7:function(e,n,r){"use strict"
var t=r("An8g")
var a=r("q1tI")
var o=r.n(a)
r("17x9")
...
return Object(t["a"])(u["a"],{as:"p",fontStyle:"italic"},void 0,Object(t["a"])(u["a"],{},void 0,n),r?f:null,r?Object(t["a"])(u["a"],{},void 0,r):null)}render(){let e=null
...
document.body.appendChild(e)}return e}function l(e){c.a.render(Object(t["a"])(v,{message:n,timeout:Number.isNaN(parseInt(ENV.flashAlertTimeout,10))?R:ENV.flashAlertTimeout,error:r,variant:o,onClose:d.bind(null,e),screenReaderOnly:s}),e)}const g=document.createElement("div")
...
//# sourceMappingURL=34-c-26252a355a.js.map