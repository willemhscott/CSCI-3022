...
n("p6Wi")
let u={}
function m(){const e=f()
g(0==e.find("#body").val().length||0==e.find(".student:not(.blank):visible").length)}window.messageStudents=function(e){const s=f()
u=e
s.find(".message_types").empty()
for(let n=0,t=e.options.length;n<t;n++){const t=r()("<option/>")
const a=e.options[n]
t.val(n).text(a.text)
...
const o=_.t("Remove %{student} from recipients",{student:s.name})
const c=n.find(".remove-button")
c.attr("title",o).append(r()("<span class='screenreader-only'></span>").text(o))
c.click((function(e){e.preventDefault()
const s=r()(this).closest("li")
s.hide("fast",m)
...
a.append(n.show())
i[s.id]=n}a.show()
const c=_.t("Message Students for %{course_name}",{course_name:n})
...
s.dialog({width:600,modal:true,open:(e,n)=>{s.closest(".ui-dialog").attr("role","dialog").attr("aria-label",c)},close:(e,n)=>{s.closest(".ui-dialog").removeAttr("role").removeAttr("aria-label")}}).dialog("open").dialog("option","title",c).on("dialogclose",e.onClose)}
r()(document).ready(()=>{const e=f()
e.find("button").click(e=>{const s=r()(e.target)
if(s.hasClass("disabled")){e.preventDefault()
e.stopPropagation()}})
r()("#message_assignment_recipients").formSubmit({processData(e){const s=[]
r()(this).find(".student:visible").each((function(){s.push(r()(this).data("id"))}))
if(0==s.length)return false
e.recipients=s.join(",")
return e},beforeSubmit(e){l(true)
r()(this).find(".send_button").text(_.t("Sending Message..."))},success(e){r.a.flashMessage(_.t("Message sent!"))
l(false)
r()(this).find(".send_button").text(_.t("Send Message"))
r()("#message_students_dialog").dialog("close")},error(e){l(false)
r()(this).find(".send_button").text(_.t("Sending Message Failed, please try again"))}})
const s=function(){const s=parseInt(e.find("select").val(),10)||0
const n=u.options[s]
const a=e.data("students_hash")
let i=c["a"].parse(e.find(".cutoff_score").val())
isNaN(i)&&(i=null)
const _=Object.values(a)
let d=[]
a&&(n&&n.callback?d=n.callback.call(window.messageStudents,i,_):u.callback&&(d=u.callback.call(window.messageStudents,n.text,i,_)))
u.subjectCallback&&e.find("[name=subject]").val(u.subjectCallback(n.text,i))
e.find(".cutoff_holder").showIf(n.cutoff)
e.find(".student_list").toggleClass("show_score",!!(n.cutoff||n.score))
l(0===d.length)
const r=new Set(d)
Object.entries(a).forEach(e=>{let s=Object(t["a"])(e,2),n=s[0],a=s[1]
a.showIf(r.has(n))})}
...
function l(e,s){null==s&&(s=f().find("button"))
s.toggleClass("disabled",e).attr("aria-disabled",e)}function g(e){l(e,f().find(".send_button"))}function f(){return r()("#message_students_dialog")}s["a"]=messageStudents},RMh6:function(e,s,n){"use strict"
var t=n("3O+N")
var a=n.n(t)
n("DfGn")
var i=a.a.default
var _=i.template,d=i.templates=i.templates||{}
var r="EmptyDialogFormWrapper"
d[r]=_((function(e,s,n,t,a){this.compilerInfo=[4,">= 1.0.0"]
n=this.merge(n,e.helpers)
a=a||{}
return'<div class="outlet"></div>\n'}))
s["a"]=d[r]},RhCJ:function(e,s,n){"use strict"
n.d(s,"a",(function(){return t}))
function t(e,s,n){if("input"===e.as){if("children"===s&&e.children||void 0==e.value)return new Error("Prop `value` and not `children` must be supplied if `".concat(n,' as="input"`'))}else{if("value"===s&&void 0!=e.value)return new Error("Prop `children` and not `value` must be supplied unless `".concat(n,' as="input"`'))
if(!e.children)return new Error("Prop `children` should be supplied unless `".concat(n,' as="input"`.'))}return}},eAd9:function(e,s,n){(function(s){var n=false
var t
var a
function i(){if("undefined"!==typeof t)return t
var e=document.documentElement
var s=document.createElement("div")
s.setAttribute("style","width:99px;height:99px;position:absolute;top:-9999px;overflow:scroll;")
e.appendChild(s)
t=s.offsetWidth-s.clientWidth
e.removeChild(s)
return t}function _(){return document.documentElement.scrollHeight>window.innerHeight}function d(e){if("undefined"===typeof document||n)return
var s=document.documentElement
a=window.pageYOffset
_()?s.style.width="calc(100% - "+i()+"px)":s.style.width="100%"
s.style.position="fixed"
s.style.top=-a+"px"
s.style.overflow="hidden"
n=true}function r(){if("undefined"===typeof document||!n)return
var e=document.documentElement
e.style.width=""
e.style.position=""
e.style.top=""
e.style.overflow=""
window.scroll(0,a)
n=false}function o(){if(n){r()
return}d()}var c={on:d,off:r,toggle:o}
"undefined"!==typeof e.exports?e.exports=c:s.noScroll=c})(this)},lkPJ:function(e,s,n){"use strict"
var t=n("ouhR")
var a=n.n(t)
const i={disableInputs(e){const s=a()("body"),n=a()("<div />",{class:"input_cover"})
n.on("mouseleave",(function(e){a()(this).remove()}))
a()(e).on("mouseenter",(function(e){const t=a()(this),i=n.clone(true)
i.css({height:t.height()+12,width:t.width()+12,position:"absolute",left:t.offset().left-6,top:t.offset().top-6,zIndex:15,background:"url(/images/blank.png) 0 0 repeat"})
s.append(i)}))},setWidths(e){a()(e||".answer input[type=text]").each((function(){a()(this).width(9.5*a()(this).val().length)}))}}
s["a"]=i},wWL5:function(e,s,n){"use strict"
n.r(s)
var t=n("ouhR")
var a=n.n(t)
var i=n("lkPJ")
...
var b=n("ppA4")
var v=n("6V2X")
a()(document).ready((function(){ENV.QUIZ_SUBMISSION_EVENTS_URL&&Object(g["a"])(true)
...
const i=new c["a"]({context:ENV.QUIZ.title,recipientGroups:[{name:t,recipients:n},{name:a,recipients:s}]})
i.open()})})
function t(e){let s=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
e&&e.preventDefault()
o.a.render(Object(_["a"])(b["a"],{open:s,sourceCourseId:ENV.COURSE_ID,contentShare:{content_type:"quiz",content_id:ENV.QUIZ.id},onDismiss:()=>{t(null,false)
a()(".al-trigger").focus()}}),document.getElementById("direct-share-mount-point"))}a()(".direct-share-send-to-menu-item").click(t)
function r(e){let s=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
e&&e.preventDefault()
o.a.render(Object(_["a"])(v["a"],{open:s,sourceCourseId:ENV.COURSE_ID,contentSelection:{quizzes:[ENV.QUIZ.id]},onDismiss:()=>{r(null,false)
...
const y=new m["a"](a.a.extend(ENV.QUIZ,{unpublishable:!h.hasClass("disabled")}))
const k=new l["a"]({model:y,el:h})
...
e.css({height:"auto"})})
e.disableWhileLoading(s)}a()("#module_sequence_footer").moduleSequenceFooter({courseID:ENV.COURSE_ID,assetType:"Quiz",assetID:ENV.QUIZ.id,location:location})})},yE80:function(e,s,n){"use strict"
var t=n("pQTu")
s["a"]={strings(e,s){let n=t["default"].locale||"en-US"
const a={zh_Hant:"zh-Hant"}
n=a[n]||n
return e.localeCompare(s,n,{sensitivity:"variant",ignorePunctuation:false,numeric:true})},by(e){return(s,n)=>this.strings(e(s),e(n))},byKey(e){return this.by(s=>s[e])},byGet(e){return this.by(s=>s.get(e))}}},ysUD:function(e,s,n){"use strict"
var t=n("VTBJ")
var a=n("rePB")
var i=n("1OyB")
var _=n("vuIU")
...
var v=n("sQ3t")
var h=n("jtGx")
function y(e){var s=e.colors,n=e.borders,t=e.stacking
return{zIndex:t.topmost,background:"rgba(255, 255, 255, 0.75)",borderColor:"transparent",focusBorderColor:s.borderBrand,borderRadius:n.radiusMedium,borderWidth:n.widthSmall}}y.canvas=function(e){return{focusBorderColor:e["ic-brand-primary"]}}
...
var z=(k=Object(b["j"])(y,j),k(S=(E=w=function(e){Object(d["a"])(n,e)
var s=Object(r["a"])(n)
function n(){var e
Object(i["a"])(this,n)
for(var t=arguments.length,a=new Array(t),_=0;_<t;_++)a[_]=arguments[_]
e=s.call.apply(s,[this].concat(a))
e.handleElementRef=function(s){e.props.elementRef(s)}
e.contentRef=function(s){e._content=s}
return e}Object(_["a"])(n,[{key:"componentDidMount",value:function(){this.props.fullscreen&&p.a.on()}},{key:"componentWillUnmount",value:function(){this.props.fullscreen&&p.a.off()}},{key:"render",value:function(){var e
var s=Object(v["a"])(this.props.children,{ref:this.contentRef})
var i=g()((e={},Object(a["a"])(e,j.root,true),Object(a["a"])(e,j[this.props.placement],true),Object(a["a"])(e,j.fullscreen,this.props.fullscreen),e))
var _=Object(t["a"])({},Object(h["a"])(this.props,n.propTypes),{className:i,ref:this.handleElementRef})
if("function"===typeof this.props.onClick){_.onClick=this.props.onClick
_.tabIndex=-1}return c.a.createElement("span",_,s)}}])
n.displayName="Mask"
return n}(o["Component"]),w.propTypes={onDismiss:m.a.func,placement:m.a.oneOf(["top","center","bottom","stretch"]),fullscreen:m.a.bool,children:m.a.node,onClick:m.a.func,elementRef:m.a.func},w.defaultProps={placement:"center",fullscreen:false,onDismiss:void 0,children:null,onClick:void 0,elementRef:function(e){}},E))||S)}}])

//# sourceMappingURL=quiz_show-c-d05279d3fc.js.map